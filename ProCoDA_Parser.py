...
def average_each_state(dates, state, column, units="", path=""):
    """Outputs the average value of the data for each instance of a state
    ...
    Example
    -------
    data_avgs = average_each_state(["6-19-2013", "6-20-2013"], "1. Backwash entire system", 28, "mL/s")
